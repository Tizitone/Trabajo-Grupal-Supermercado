...
public class Main {
	...
	public static void main(String[] args) {
		...
		CV cv2 = new CV("Mario", "Rodriguez", 23, "2236778090", "marioRodriguez@gmail.com", 'h');
		Entrevista e2 = new Entrevista(9, 12, 2026, 15, 45, cv2, "");
		CV cv3 = new CV("Geremias", "Rodriguez", 23, "2234568890", "gereRodriguez@gmail.com", 'h');
		...
		TarjetaMembresia miembro = new TarjetaMembresia(TarjetaMembresia.Membresia.cobre);
